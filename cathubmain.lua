...
--CheckBypassAntiCheat()
    ...
    local Swords = Library:Tab("Wepons","rbxassetid://9606626034")
    ...
    local AutoMisc = Library:Tab("Settings","rbxassetid://11446835336")
    
    Main:Label("Welcome "..game.Players.LocalPlayer.DisplayName)
    
    local Time = Main:Label("Server Time")
    function UpdateTime()
    ...
    local Thanksforreport = Main:Label("Report Bug")
    
    local ReportBugs = nill
    Main:Textbox("Text Report Bug",false, function(value)
    ...
    Main:Label("Join Invite Discord : Cat Hub")
    ...
    _G.Select_Mode_Farm = "Normal Farm"
    
    Main:Dropdown("Select Mode Farm", {
    "Normal Farm","Fast Mode","No Quest"},function(value)
    ...
    "Behind","Below","Upper","Bypass AntiCheat"
    },function(value)
    _G.Method = value
    end)
    ...
    MethodFarm = CFrame.new(0,_G.DistanceMob,0) * CFrame.Angles(math.rad(-90),0,0)
    elseif _G.Method == "Bypass AntiCheat" then
    MethodFarm = CFrame.new(TypeFarm)
    else
    ...
    Main:Toggle("Auto Farm On Select Farm Mode",_G.Auto_Farm_Level,function(value)
    ...
    if World1 then
        ...
        --v.Humanoid:ChangeState(14)
            ...
            Tween(v.CFrame * CFrame.new(MethodFarm))
            end
            end
            end
            end
    ...
    wait(1)
    Notification:Notify(
    {Title = "Cat Hub", Description = "You Have Max Observation"},
    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
    {Image = "http://www.roblox.com/asset/?id=0", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
    )
                    else
                        if World2 then
    ...
    local BoneFarm = Swords:Toggle("Auto Farm Bone",_G.AutoBone,function(value)
        _G.AutoBone = value
        StopTween(_G.AutoBone)
                             ...
                             spawn(function()
                                ...
                                pcall(function()
                                 ...
                                 StatrMagnet = true
                                 until not _G.AutoBone or not v.Parent or v.Humanoid.Health == 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
                                 end
                                 end
                                 end
                                 end
    ...
    Swords:Toggle("Auto Quest Soul Guitar",_G.AutoQuestSoulGuitar,function(value)
    ...
    if World2 then
    Swords:Seperator("Legendary Sword")
    
    Swords:Toggle("Auto Legendary Sword",_G.AutoBuyLegendarySword,function(value)
    ...
    Swords:Toggle("Auto Legendary Sword Hop",_G.AutoBuyLegendarySword_Hop,function(value)
        _G.AutoBuyLegendarySword_Hop = value
    end)
    end
    
    if World2 or World3 then
    Swords:Seperator("Enchancement Colour")
    
    Swords:Toggle("Auto Enchancement Colour",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    Swords:Toggle("Auto Enchancement Hop",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    if World2 or World3 then
    Swords:Seperator("Others")
    end
    
    if World3 then
    Swords:Toggle("Auto Musketeer Hat",_G.AutoMusketeerHat,function(value)
    ...
    if World3 then
    Swords:Toggle("Auto Observation Haki v2",_G.AutoObservationv2,function(value)
    ...
    if World3 then
    Swords:Toggle("Auto Haki Rainbow",_G.AutoHakiRainbow,function(value)
    ...
    if World2 then
    Swords:Toggle("Auto Rengoku",_G.AutoRengoku,function(value)
    ...
    if World2 then
    Swords:Toggle("Auto Evo Race",_G.Auto_EvoRace,function(value)
    ...
    if World2 then
    Swords:Toggle("Auto Bartlio Quest",_G.AutoBartilo,function(value)
    ...
    if World3 then
    Swords:Toggle("Auto Open Color Haki",_G.Farm_Ob_Color,function(vu)
    Open_Color_Haki = vu
    _G.Farm_Ob_Color = vu
    end)
    ...
    Swords:Toggle("Auto Holy Torch",_G.HolyTorch,function(value)
    _G.HolyTorch = value
    ...
    if World3 then
    Swords:Toggle("Auto Phoenix Advance Dungeon",_G.AutoAdvanceDungeon,function(value)
    ...
    Swords:Seperator("Fighting Style")
    
    Swords:Toggle("Auto Superhuman",_G.Auto_Fully_Superhuman,function(value)
    ...
    Swords:Toggle("Auto Death Step",_G.Auto_Fully_Death_Step,function(value)
    ...
    Swords:Toggle("Auto Sharkman Karate",_G.Auto_Fully_SharkMan_Karate,function(value)
    ...
    Swords:Toggle("Auto Electric Claw",_G.AutoElectricClaw, function(value)
    ...
    while wait(.1) do
     ...
     Swords:Toggle("Auto Dragon Talon",_G.AutoDragonTalon,function(value)
    ...
    Swords:Toggle("Auto God Human",_G.AutoFullyGodhuman,function(value)
    ...
    Mirragecheck:Set('🏝️ : Mirage Island Has Spawning')
    else
      Mirragecheck:Set('🏝️ : Mirage Island Has Not Spawning')
    end
            end
        end)
    end)
    ...
    game.StarterGui:SetCore("SendNotification", {
        Title = "CatHub"; -- the title (ofc)
        Text = "Mirage Has Not spawning"; -- what the text says (ofc)
    ...
    AutoMisc:Seperator("Settings")
    
    AutoMisc:Toggle("Bring Mob",true,function(value)
        _G.BringMonster = value
    end)
    
    AutoMisc:Toggle("Bring Mob [V2]",false,function(value)
    _G.BringExtra = value
    end)
    ...
    AutoMisc:Toggle("Auto Set Spawn Points",true,function(value)
    ...
    AutoMisc:Toggle("Remove Death Effect",_G.Remove_EffectDeath,function(value)
    ...
    AutoMisc:Toggle("Magnet",true,function(vu)
        _G.MagnetActive = vu
        end)
    ...
    AutoMisc:Toggle("Fast Attack 1",true,function(value)
            _G.FastAttack = value
        end)      
        
        AutoMisc:Toggle("Fast Attack 2",nil,function(value)
    ...
    AutoMisc:Toggle("Fast Attack 3",false,function(Fast)
        _G.FastAttack = Fast
    end)
    ...
    AutoMisc:Toggle("Fast Attack 4",false,function(value)
    ...
    AutoMisc:Toggle("Fast Attack 5",false,function(value)
        _G.FastAttack = value
            end)
    ...
    while task.wait() do
        pcall(function()
            if _G.Auto_Farm_Level and _G.Select_Mode_Farm == "Normal Farm" and _G.Select_Mode_Farm == "Easy Mode" and _G.Select_Mode_Farm == "Hard Mode" and _G.Select_Mode_Farm == "Fast Mode" and _G.Select_Mode_Farm == "No Quest" then
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.Name == Ms and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                        v.Humanoid.WalkSpeed = 0
                        v.Humanoid.JumpPower = 0
    ...
    Combat:Toggle("AimBot Skill And Gun",false,function(value)
    ...
    if World3 then
    ESPM:Toggle("ESP Real Fruit",esprealfruit,function(a)
        RealFruitESP = a
